...
// Ported verbatim from KEDA pkg/scalers/selenium_grid_scaler_test.go
// (Test_getCountFromSeleniumResponse). Expected values are unchanged — this is
// the algorithm parity gate. See PLAN.md T3.
