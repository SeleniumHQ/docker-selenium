# Vaadin Testbench Base Image

_This image is not meant to be run directly!_ It serves as the base image used for each of the Vaadin Testbench images involved in setting up a Vaadin Testbench Grid.

## Dockerfile

[`urosporo/testbench-base` Dockerfile](https://github.com/urosporo/docker-vaadin-testbench/blob/master/Base/Dockerfile)
