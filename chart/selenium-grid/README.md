...
| ----------------------------------- | ---------------------------------- | ------------------------------------- |
| `global.seleniumGrid.imageTag`      | `4.1.2-20220217`                   | Image tag for all selenium components |
| `global.seleniumGrid.nodesImageTag` | `4.1.2-20220217`                   | Image tag for browser's nodes         |
...
| `chromeNode.imageTag`                   | `4.1.2-20220217`                   | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                  | `4.1.2-20220217`                   | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                     | `4.1.2-20220217`                   | Image of edge nodes                                                                                                        |
