...
| ----------------------------------- | ---------------------------------- | ------------------------------------- |
| `global.seleniumGrid.imageTag`      | `4.0.0-20211013`                   | Image tag for all selenium components |
| `global.seleniumGrid.nodesImageTag` | `4.0.0-20211013`                   | Image tag for browser's nodes         |
...
| `chromeNode.imageTag`                   | `4.0.0-20211013`                   | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                  | `4.0.0-20211013`                   | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                     | `4.0.0-20211013`                   | Image of edge nodes                                                                                                        |
