...
| ----------------------------------- | ---------------------------------- | ------------------------------------- |
| `global.seleniumGrid.imageTag`      | `4.0.0-20211025`                   | Image tag for all selenium components |
| `global.seleniumGrid.nodesImageTag` | `4.0.0-20211025`                   | Image tag for browser's nodes         |
