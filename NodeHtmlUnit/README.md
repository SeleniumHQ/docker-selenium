# Selenium Grid Node - HtmlUnit

Selenium Node configured to run HtmlUnit

## Dockerfile

[`selenium/node-htmlunit` Dockerfile](https://github.com/SeleniumHQ/docker-selenium/blob/master/NodeHtmlUnit/Dockerfile)
...
```
$ docker run -d --link selenium-hub:hub selenium/node-htmlunit
```
