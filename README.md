...
The internal 5900 port remains the same because that is the configured port for the VNC server running inside the container. You can override it with in VNC_PORT environment variable in case you want to use --net=host.
