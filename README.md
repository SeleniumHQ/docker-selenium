...
Tests execution can be recorded by using the `selenium/video:ffmpeg-4.3.1-20211102`
...
$ docker run -d --net grid --name video -v /tmp/videos:/videos selenium/video:ffmpeg-4.3.1-20211102
# Run your tests
