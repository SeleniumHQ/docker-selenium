...
our [releases](https://github.com/SeleniumHQ/docker-selenium/releases/tag/4.8.0-20230123).
...
Tests execution can be recorded by using the `selenium/video:ffmpeg-4.3.1-20230123`
...
Dockerfile example that extends the `node-chrome:4.8.0-20230123`. You can choose another browser image or a Standalone
browser image.
...
And from now on, instead of using `node-chrome:4.8.0-20230123` in your scripts or docker-compose files, use
`selenium/node-chrome-vnc-password-changed:4.8.0-20230123`.
