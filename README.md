...
our [prereleases](https://github.com/SeleniumHQ/docker-selenium/releases/tag/4.0.0-beta-1-prerelease-20201202)
...
$ docker run -d --net grid -e SE_EVENT_BUS_HOST=selenium-hub \
    ...
    -v /dev/shm:/dev/shm \
    selenium/node-chrome:4.0.0-beta-1-prerelease-20201202
$ docker run -d --net grid -e SE_EVENT_BUS_HOST=selenium-hub \
    -e SE_EVENT_BUS_PUBLISH_PORT=4442 \
    -e SE_EVENT_BUS_SUBSCRIBE_PORT=4443 \
...
$ docker run -d -p 5555:5555 
    ...
    -v /dev/shm:/dev/shm \
    selenium/node-firefox:4.0.0-beta-1-prerelease-20201202
```
...
$ docker run -d -p 5555:5555 
    ...
    -v /dev/shm:/dev/shm \
    selenium/node-opera:4.0.0-beta-1-prerelease-20201202
```
...
It is possible to record your tests running in containers by using the `selenium/video:ffmpeg-4.3.1-20201202`
...
$ docker run -d -p 4444:4444 --net grid --name selenium-hub \
    ...
    selenium/hub:4.0.0-beta-1-prerelease-20201202
