...
``` bash
$ docker run -d -p 4444:4444 -v /dev/shm:/dev/shm selenium/standalone-chrome:2.53.1-beryllium
```
...
``` bash
$ docker run -d -p 4444:4444 selenium/standalone-chrome:2.53.1-beryllium
# OR
...
``` bash
$ docker run -d --link selenium-hub:hub selenium/node-chrome:2.53.1-beryllium
$ docker run -d --link selenium-hub:hub selenium/node-firefox:2.53.1-beryllium
```
...
``` bash
$ docker run -d -p 4444:4444 -e JAVA_OPTS=-Xmx512m --name selenium-hub selenium/hub:2.53.1-beryllium
```
...
``` bash
$ docker run -d -p 4444:4444 -e SE_OPTS=-debug --name selenium-hub selenium/hub:2.53.1-beryllium
```
...
``` bash
$ docker run -d --name selenium-hub -p 4444:4444 selenium/hub:2.53.1-beryllium
$ CH=$(docker run --rm --name=ch \
    --link selenium-hub:hub -v /e2e/uploads:/e2e/uploads \
    selenium/node-chrome:2.53.1-beryllium)
```
...
``` bash
$ docker run -d -P -p <port4VNC>:5900 --link selenium-hub:hub selenium/node-chrome-debug:2.53.1-beryllium
$ docker run -d -P -p <port4VNC>:5900 --link selenium-hub:hub selenium/node-firefox-debug:2.53.1-beryllium
```
e.g.:
``` bash
$ docker run -d -P -p 5900:5900 --link selenium-hub:hub selenium/node-chrome-debug:2.53.1-beryllium
$ docker run -d -P -p 5901:5900 --link selenium-hub:hub selenium/node-firefox-debug:2.53.1-beryllium
```
...
And for standalone:
``` bash
$ docker run -d -p 4444:4444 -p <port4VNC>:5900 selenium/standalone-chrome-debug:2.53.1-beryllium
# OR
$ docker run -d -p 4444:4444 -p <port4VNC>:5900 selenium/standalone-firefox-debug:2.53.1-beryllium
```
or
``` bash
$ docker run -d -p 4444:4444 -p 5900:5900 selenium/standalone-chrome-debug:2.53.1-beryllium
# OR
$ docker run -d -p 4444:4444 -p 5901:5900 selenium/standalone-firefox-debug:2.53.1-beryllium
```
...
#FROM selenium/node-firefox-debug:2.53.1-beryllium
...
selenium/node-firefox           2.53.1-beryllium              69f762d0d79e        29 minutes ago      552.1 MB
selenium/node-chrome            2.53.1-beryllium              9dd73160660b        30 minutes ago      723.6 MB
selenium/node-base              2.53.1-beryllium              1b7a0b7024b1        32 minutes ago      426.1 MB
selenium/hub                    2.53.1-beryllium              2570bbb98229        33 minutes ago      394.4 MB
selenium/base                   2.53.1-beryllium              33478d455dab        33 minutes ago      362.6 MB
