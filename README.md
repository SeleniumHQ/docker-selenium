...
our [prereleases](https://github.com/SeleniumHQ/docker-selenium/releases/tag/4.0.0-beta-2-prerelease-20210312)
...
``` bash
$ docker run -d -p 4444:4444 --shm-size 2g selenium/standalone-firefox:4.0.0-beta-2-prerelease-20210312
# OR
$ docker run -d -p 4444:4444 -v /dev/shm:/dev/shm selenium/standalone-firefox:4.0.0-beta-2-prerelease-20210312
```
...
``` bash
$ docker run -d -p 4444:4444 -v /dev/shm:/dev/shm selenium/standalone-chrome:4.0.0-beta-2-prerelease-20210312
```

![Opera](https://raw.githubusercontent.com/alrra/browser-logos/main/src/opera/opera_24x24.png) Opera 
``` bash
$ docker run -d -p 4444:4444 -v /dev/shm:/dev/shm selenium/standalone-opera:4.0.0-beta-2-prerelease-20210312
```

![Edge](https://raw.githubusercontent.com/alrra/browser-logos/main/src/edge/edge_24x24.png) Microsoft Edge
``` bash
$ docker run -d -p 4444:4444 -v /dev/shm:/dev/shm selenium/standalone-edge:4.0.0-beta-2-prerelease-20210312
```
...
$ docker run -d -p 4442-4444:4442-4444 --net grid --name selenium-hub selenium/hub:4.0.0-beta-2-prerelease-20210312
$ docker run -d --net grid -e SE_EVENT_BUS_HOST=selenium-hub \
    -e SE_EVENT_BUS_PUBLISH_PORT=4442 \
    -e SE_EVENT_BUS_SUBSCRIBE_PORT=4443 \
    -v /dev/shm:/dev/shm \
    selenium/node-chrome:4.0.0-beta-2-prerelease-20210312
$ docker run -d --net grid -e SE_EVENT_BUS_HOST=selenium-hub \
    -e SE_EVENT_BUS_PUBLISH_PORT=4442 \
    -e SE_EVENT_BUS_SUBSCRIBE_PORT=4443 \
    -v /dev/shm:/dev/shm \
    selenium/node-edge:4.0.0-beta-2-prerelease-20210312
$ docker run -d --net grid -e SE_EVENT_BUS_HOST=selenium-hub \
    -e SE_EVENT_BUS_PUBLISH_PORT=4442 \
    -e SE_EVENT_BUS_SUBSCRIBE_PORT=4443 \
    -v /dev/shm:/dev/shm \
    selenium/node-firefox:4.0.0-beta-2-prerelease-20210312
$ docker run -d --net grid -e SE_EVENT_BUS_HOST=selenium-hub \
    -e SE_EVENT_BUS_PUBLISH_PORT=4442 \
    -e SE_EVENT_BUS_SUBSCRIBE_PORT=4443 \
    -v /dev/shm:/dev/shm \
    selenium/node-opera:4.0.0-beta-2-prerelease-20210312
```
...
Hub - Machine/VM 1
``` bash
$ docker run -d -p 4442-4444:4442-4444 --name selenium-hub selenium/hub:4.0.0-beta-2-prerelease-20210312
```
...
It is possible to record your tests running in containers by using the `selenium/video:ffmpeg-4.3.1-20210312`
...
``` bash
$ docker network create grid
$ docker run -d -p 4444:4444 -p 6900:5900 --net grid --name selenium -v /dev/shm:/dev/shm selenium/standalone-chrome:4.0.0-beta-2-prerelease-20210312
$ docker run -d --net grid --name video -v /tmp/videos:/videos selenium/video:ffmpeg-4.3.1-20210312
# Run your tests
...
configs = [
    "selenium/standalone-firefox:4.0.0-beta-2-prerelease-20210312", "{\"browserName\": \"firefox\"}",
    "selenium/standalone-chrome:4.0.0-beta-2-prerelease-20210312", "{\"browserName\": \"chrome\"}",
    "selenium/standalone-opera:4.0.0-beta-2-prerelease-20210312", "{\"browserName\": \"operablink\"}",
    "selenium/standalone-edge:4.0.0-beta-2-prerelease-20210312", "{\"browserName\": \"msedge\"}"
    ]
...
video-image = "selenium/video:ffmpeg-4.3.1-20210312"
...
$ docker run -d --net grid -e SE_EVENT_BUS_HOST=selenium-hub \
    ...
    selenium/node-docker:4.0.0-beta-2-prerelease-20210312
```
...
docker run --rm -ti --name selenium-docker -p 4444:4444 \
    -v ${PWD}/config.toml:/opt/bin/config.toml \
    -v /path/on/your/host/machine:/opt/selenium/assets \
    selenium/standalone-docker:4.0.0-beta-2-prerelease-20210312
```
...
``` bash
$ docker run -d -p 4444:4444 -e SE_OPTS="-debug" --name selenium-hub selenium/hub:4.0.0-beta-2-prerelease-20210312
```
...
``` bash
$ docker run -d -p 4444:4444 -e JAVA_OPTS=-Xmx512m --name selenium-hub selenium/hub:4.0.0-beta-2-prerelease-20210312
```
...
```bash
$ docker run -d --e SE_EVENT_BUS_HOST=<event_bus_ip|event_bus_name> -e SE_EVENT_BUS_PUBLISH_PORT=4442 -e SE_EVENT_BUS_SUBSCRIBE_PORT=4443 -v /dev/shm:/dev/shm selenium/node-chrome:4.0.0-beta-2-prerelease-20210312
```
...
$ docker run -d --net grid -e SE_EVENT_BUS_HOST=selenium-hub \
    ...
    -v /dev/shm:/dev/shm \
    -v /e2e/uploads:/e2e/uploads selenium/node-firefox:4.0.0-beta-2-prerelease-20210312
```
...
$ docker run -d -p 4444:4444 --net grid --name selenium-hub \
    ...
    selenium/hub:4.0.0-beta-2-prerelease-20210312
$ docker run -d --net grid -e HUB_HOST=selenium-hub -v /dev/shm:/dev/shm selenium/node-chrome:4.0.0-beta-2-prerelease-20210312
$ docker run -d --net grid -e HUB_HOST=selenium-hub -v /dev/shm:/dev/shm selenium/node-edge:4.0.0-beta-2-prerelease-20210312
$ docker run -d --net grid -e HUB_HOST=selenium-hub -v /dev/shm:/dev/shm selenium/node-firefox:4.0.0-beta-2-prerelease-20210312
$ docker run -d --net grid -e HUB_HOST=selenium-hub -v /dev/shm:/dev/shm selenium/node-opera:4.0.0-beta-2-prerelease-20210312
```
...
``` bash
$ docker run -d -p 4444:4444 -p 5900:5900 -v /dev/shm:/dev/shm selenium/standalone-chrome:4.0.0-beta-2-prerelease-20210312
$ docker run -d -p 4444:4444 -p 5900:5900 -v /dev/shm:/dev/shm selenium/standalone-edge:4.0.0-beta-2-prerelease-20210312
$ docker run -d -p 4445:4444 -p 5901:5900 -v /dev/shm:/dev/shm selenium/standalone-firefox:4.0.0-beta-2-prerelease-20210312
$ docker run -d -p 4446:4444 -p 5902:5900 -v /dev/shm:/dev/shm selenium/standalone-opera:4.0.0-beta-2-prerelease-20210312
```
...
``` dockerfile
#FROM selenium/node-chrome:4.0.0-beta-2-prerelease-20210312
#FROM selenium/node-edge:4.0.0-beta-2-prerelease-20210312
#FROM selenium/node-firefox:4.0.0-beta-2-prerelease-20210312
#FROM selenium/node-opera:4.0.0-beta-2-prerelease-20210312
