...
| SE_PRESET | -preset | Set the preset for FFmpeg in video recording |  |
...
| SE_VIDEO_FILE_NAME_TRIM_REGEX |  | Bash regex to trim the file name if it is too long |  |
