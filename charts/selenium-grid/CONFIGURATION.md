...
![Version: 0.40.0](https://img.shields.io/badge/Version-0.40.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.29.0-20250222](https://img.shields.io/badge/AppVersion-4.29.0--20250222-informational?style=flat-square)
...
| https://prometheus-community.github.io/helm-charts | kube-prometheus-stack | 69.7.2 |
...
| global.seleniumGrid.imageTag | string | `"4.29.0-20250222"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.29.0-20250222"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-7.1-20250222"` | Image tag for browser's video recorder |
...
| keda.image | object | `{"keda":{"registry":"selenium","repository":"keda","tag":"2.16.1-selenium-grid-20250222"},"metricsApiServer":{"registry":"selenium","repository":"keda-metrics-apiserver","tag":"2.16.1-selenium-grid-20250222"},"webhooks":{"registry":"selenium","repository":"keda-admission-webhooks","tag":"2.16.1-selenium-grid-20250222"}}` | Specify image for KEDA components |
