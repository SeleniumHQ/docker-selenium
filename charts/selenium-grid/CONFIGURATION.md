...
![Version: 0.47.0](https://img.shields.io/badge/Version-0.47.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.36.0-20251001](https://img.shields.io/badge/AppVersion-4.36.0--20251001-informational?style=flat-square)
...
| https://prometheus-community.github.io/helm-charts | kube-prometheus-stack | ^77.0.0 |
...
| global.seleniumGrid.imageTag | string | `"4.36.0-20251001"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.36.0-20251001"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-8.0-20251001"` | Image tag for browser's video recorder |
