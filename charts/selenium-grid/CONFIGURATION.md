...
![Version: 0.42.1](https://img.shields.io/badge/Version-0.42.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.31.0-20250414](https://img.shields.io/badge/AppVersion-4.31.0--20250414-informational?style=flat-square)
...
| https://charts.bitnami.com/bitnami | redis | 20.13.3 |
...
| https://prometheus-community.github.io/helm-charts | kube-prometheus-stack | 70.8.0 |
...
| global.seleniumGrid.imageTag | string | `"4.31.0-20250414"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.31.0-20250414"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-7.1-20250414"` | Image tag for browser's video recorder |
