...
![Version: 0.35.0](https://img.shields.io/badge/Version-0.35.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.24.0-20240830](https://img.shields.io/badge/AppVersion-4.24.0--20240830-informational?style=flat-square)
...
| global.seleniumGrid.imageTag | string | `"4.24.0-20240830"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.24.0-20240830"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-7.0.2-20240830"` | Image tag for browser's video recorder |
