...
![Version: 0.42.0](https://img.shields.io/badge/Version-0.42.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.31.0-20250404](https://img.shields.io/badge/AppVersion-4.31.0--20250404-informational?style=flat-square)
...
| global.seleniumGrid.imageTag | string | `"4.31.0-20250404"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.31.0-20250404"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-7.1-20250404"` | Image tag for browser's video recorder |
