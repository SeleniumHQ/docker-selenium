...
![Version: 0.55.0](https://img.shields.io/badge/Version-0.55.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.44.0-20260505](https://img.shields.io/badge/AppVersion-4.44.0--20260505-informational?style=flat-square)
...
| global.seleniumGrid.imageTag | string | `"4.44.0-20260505"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.44.0-20260505"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-8.1-20260505"` | Image tag for browser's video recorder |
