...
![Version: 0.43.2](https://img.shields.io/badge/Version-0.43.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 4.32.0-20250515](https://img.shields.io/badge/AppVersion-4.32.0--20250515-informational?style=flat-square)
...
| global.seleniumGrid.imageTag | string | `"4.32.0-20250515"` | Image tag for all selenium components |
| global.seleniumGrid.nodesImageTag | string | `"4.32.0-20250515"` | Image tag for browser's nodes |
| global.seleniumGrid.videoImageTag | string | `"ffmpeg-7.1-20250515"` | Image tag for browser's video recorder |
