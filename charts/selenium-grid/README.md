...
| ----------------------------------- | ---------------------------------- | ------------------------------------- |
| `global.seleniumGrid.imageTag`      | `4.3.0-20220624`                   | Image tag for all selenium components |
| `global.seleniumGrid.nodesImageTag` | `4.3.0-20220624`                   | Image tag for browser's nodes         |
...
| `chromeNode.imageTag`                   | `4.3.0-20220624`                   | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                  | `4.3.0-20220624`                   | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                     | `4.3.0-20220624`                   | Image of edge nodes                                                                                                        |
