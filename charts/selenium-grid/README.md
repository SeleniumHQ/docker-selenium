...
|---------------------------------------|-------------------|---------------------------------------|
| `global.seleniumGrid.imageTag`        | `4.13.0-20231004` | Image tag for all selenium components |
| `global.seleniumGrid.nodesImageTag`   | `4.13.0-20231004` | Image tag for browser's nodes         |
...
| `chromeNode.imageTag`                       | `4.13.0-20231004`                           | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                      | `4.13.0-20231004`                           | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                         | `4.13.0-20231004`                           | Image of edge nodes                                                                                                        |
