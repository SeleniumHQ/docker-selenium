...
| `global.seleniumGrid.imageTag`                 | `4.21.0-20240517`       | Image tag for all selenium components    |
| `global.seleniumGrid.nodesImageTag`            | `4.21.0-20240517`       | Image tag for browser's nodes            |
| `global.seleniumGrid.videoImageTag`            | `ffmpeg-6.1.1-20240517` | Image tag for browser's video recorder   |
...
| `chromeNode.imageTag`                         | `4.21.0-20240517`                           | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                        | `4.21.0-20240517`                           | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                           | `4.21.0-20240517`                           | Image of edge nodes                                                                                                        |
...
| `videoRecorder.imageTag`                      | `ffmpeg-6.1.1-20240517`                     | Image tag of video recorder                                                                                                |
