...
| ----------------------------------- | ---------------------------------- | ------------------------------------- |
| `global.seleniumGrid.imageTag`      | `4.2.1-20220608`                   | Image tag for all selenium components |
| `global.seleniumGrid.nodesImageTag` | `4.2.1-20220608`                   | Image tag for browser's nodes         |
...
| `chromeNode.imageTag`                   | `4.2.1-20220608`                   | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                  | `4.2.1-20220608`                   | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                     | `4.2.1-20220608`                   | Image of edge nodes                                                                                                        |
