...
| `global.seleniumGrid.imageTag`        | `4.16.1-20231208`     | Image tag for all selenium components |
| `global.seleniumGrid.nodesImageTag`   | `4.16.1-20231208`     | Image tag for browser's nodes         |
| `global.seleniumGrid.videoImageTag`   | `ffmpeg-6.1-20231208` | Image tag for browser's video recoder |
...
| `chromeNode.imageTag`                         | `4.16.1-20231208`                           | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                        | `4.16.1-20231208`                           | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                           | `4.16.1-20231208`                           | Image of edge nodes                                                                                                        |
...
| `videoRecorder.imageTag`                      | `ffmpeg-6.1-20231208`                       | Image tag of video recorder                                                                                                |
