...
| `global.seleniumGrid.imageTag`                      | `4.22.0-20240621`       | Image tag for all selenium components       |
| `global.seleniumGrid.nodesImageTag`                 | `4.22.0-20240621`       | Image tag for browser's nodes               |
| `global.seleniumGrid.videoImageTag`                 | `ffmpeg-6.1.1-20240621` | Image tag for browser's video recorder      |
...
| `chromeNode.imageTag`                         | `4.22.0-20240621`                           | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                        | `4.22.0-20240621`                           | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                           | `4.22.0-20240621`                           | Image of edge nodes                                                                                                        |
...
| `videoRecorder.imageTag`                      | `ffmpeg-6.1.1-20240621`                     | Image tag of video recorder                                                                                                |
