...
| `global.seleniumGrid.imageTag`                      | `4.24.0-20240830`       | Image tag for all selenium components                               |
| `global.seleniumGrid.nodesImageTag`                 | `4.24.0-20240830`       | Image tag for browser's nodes                                       |
| `global.seleniumGrid.videoImageTag`                 | `ffmpeg-7.0.2-20240830` | Image tag for browser's video recorder                              |
...
| `chromeNode.imageTag`                         | `4.24.0-20240830`                           | Image of chrome nodes                                                                                                      |
...
| `firefoxNode.imageTag`                        | `4.24.0-20240830`                           | Image of firefox nodes                                                                                                     |
...
| `edgeNode.imageTag`                           | `4.24.0-20240830`                           | Image of edge nodes                                                                                                        |
...
| `videoRecorder.imageTag`                      | `ffmpeg-7.0.2-20240830`                     | Image tag of video recorder                                                                                                |
