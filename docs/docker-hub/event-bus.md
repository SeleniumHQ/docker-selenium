...
```
selenium/event-bus-<Major>.<Minor>.<Patch>-<YYYYMMDD>
```
...
e126989f151e        selenium/event-bus   <Major>
e126989f151e        selenium/event-bus   <Major>.<Minor>
e126989f151e        selenium/event-bus   <Major>.<Minor>.<Patch>
e126989f151e        selenium/event-bus   <Major>.<Minor>.<Patch>-<YYYYMMDD>
```
