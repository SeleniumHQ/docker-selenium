# Selenium Grid Node - Chromium

Selenium Node configured to run Chromium.

## Dockerfile

[`selenium/node-chromium` Dockerfile](https://github.com/SeleniumHQ/docker-selenium/blob/master/NodeChromium/Dockerfile)
...
```
$ docker run -d --link selenium-hub:hub -v /dev/shm:/dev/shm selenium/node-chromium
```
