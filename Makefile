...
BASE_RELEASE := $(or $(BASE_RELEASE),$(BASE_RELEASE),selenium-4.29.0)
BASE_VERSION := $(or $(BASE_VERSION),$(BASE_VERSION),4.29.0)
BINDING_VERSION := $(or $(BINDING_VERSION),$(BINDING_VERSION),4.29.0)
BASE_RELEASE_NIGHTLY := $(or $(BASE_RELEASE_NIGHTLY),$(BASE_RELEASE_NIGHTLY),nightly)
BASE_VERSION_NIGHTLY := $(or $(BASE_VERSION_NIGHTLY),$(BASE_VERSION_NIGHTLY),4.30.0-SNAPSHOT)
VERSION := $(or $(VERSION),$(VERSION),4.29.0)
MVN_SELENIUM_VERSION := $(or $(MVN_SELENIUM_VERSION),$(MVN_SELENIUM_VERSION),4.29.0)
